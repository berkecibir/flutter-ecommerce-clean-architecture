...
class _ProductApiService implements ProductApiService {
  ...
  @override
  Future<HttpResponse<Map<String, dynamic>>> getProducts() async {
    ...
    try {
      // DÜZELTME: Retrofit generator dynamic.fromJson() hatası - sadece raw data döndürüyoruz
      // Eski kod: _value = _result.data!.map((k, dynamic v) => MapEntry(k, dynamic.fromJson(v as Map<String, dynamic>)));
      _value = _result.data!;
    } on Object catch (e, s) {
